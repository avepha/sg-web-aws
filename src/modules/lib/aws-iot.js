...
// shadow imp
export const registerThing = (thingName, handler) => {
  const client = new IoTClient();
  client.registerThing(thingName, handler)
}

export const attachThingConnectHander = (handler) => {
  const client = new IoTClient();
  client.attachThingConnect(handler);
}

export const attachThingErrorHandler = (handler) => {
  const client = new IoTClient();
  client.attachThingError(handler);
}

export const attachThingStatusHandler = (handler) => {
  const client = new IoTClient();
  client.attachThingStatus(handler);
}

export const attachThingDeltaHandler = (handler) => {
  const client = new IoTClient();
  client.attachThingDelta(handler);
}

export const updateThing = (thingName, data) => {
  const client = new IoTClient();
  client.updateThing(thingName, data);
}

export const getThing = (thingName) => {
  const client = new IoTClient();
  client.getThing(thingName);
}

export const requestShadow = (thingName) => {
  const client = new IoTClient();
  client.requestShadow(thingName);
}
