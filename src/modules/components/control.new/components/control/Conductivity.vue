                ...
                <form class="smart-form">
                    ...
                    <fieldset>
                        <section>
                            ...
                            <label class="input">
                                <input type="number" class="input-md">
                            </label>
                        </section>
                        <section>
                    ...
                    <!-- <app-range :sliderobj="obj" id="setpointslider" style="margin-bottom: 20px;"></app-range> -->
                    <app-range :sliderobj="rangeObj" id="setpointslider" style="margin-bottom: 20px;" disabled="true"></app-range>
                    <footer>
