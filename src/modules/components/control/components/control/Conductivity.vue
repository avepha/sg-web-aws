            ...
            <div class="widget-body">
                <form class="smart-form">
                    ...
                    <fieldset>
                        ...
                        <app-range :sliderobj="rangeObj" v-model="value" id="setpointslider" style="margin-bottom: 20px;" disabled="true"></app-range>
                    </div>
                    <footer>
...
<script>
    ...
    export default {
        ...
        methods: {
            update: function () {
                console.log('update');
                this.control = JSON.parse(JSON.stringify(this.GET_CONTROL[2]));
            ...
            submit: function () {
                this.GET_CONTROL[2].setpoint.setpoint = this.value;
                this.GET_CONTROL[2].setpoint.working = this.working;
                this.GET_CONTROL[2].setpoint.detecting = this.detecting;
                this.GET_CONTROL[2].mode = this.activation?2:0;
