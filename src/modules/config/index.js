...
export default {
  ...
  awsCognitoUserPoolAppClientId: config.AwsCognitoUserPoolAppClientId,
  awsCognitoIdentityPoolId: config.AwsCognitoIdentityPoolId,
  awsApiGatewayInvokeUrl: config.AwsApiGatewayInvokeUrl,
  socialFacebookAppId: config.SocialFacebookAppId,
